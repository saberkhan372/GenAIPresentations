...
This note documents the optional transparency afterword in Slide 16 of **Meaning ↔ Prediction**. The slide is not part of the required pedagogical close. Every environmental number is modeled rather than metered and should be treated as an order-of-magnitude estimate with at least threefold uncertainty.

## Headline estimates

| Scope | Inference electricity | CO₂e | Operational water |
|---|---:|---:|---:|
| This workshop deck’s drafts, implementation, review, and deployment | **approximately 1 kWh** (0.3–3) | **approximately 0.35 kg** (0.04–2.1) | **approximately 3–4 L** (0.1–12) |
...
Neither system had provider telemetry. The token estimates differ by roughly threefold at their central values, but both approaches place the workshop-deck build near the same order of magnitude. Slide 16 reports a rounded midpoint and preserves the wider uncertainty range.
...
Authorship changes depending on what is counted. Slide 16 keeps two lenses separate rather than presenting one ownership score.
...
## U.S. and Bangladesh scale comparisons
...
- United States: approximately **12,835 kWh per person per year** in 2024, or **35 kWh per day**.
- Bangladesh: approximately **603 kWh per person per year** in 2023, or **1.7 kWh per day**.

At those rates, the deck’s modeled 1 kWh is equivalent to roughly:

- **41 minutes** of the U.S. per-resident national average; or
- **14½ hours** of the Bangladesh per-resident national average.

### Water

World Bank/FAO AQUASTAT data imply approximate municipal water withdrawal of:

- United States: **480 L per person per day**;
- Bangladesh: **58 L per person per day**.

Municipal withdrawal includes public-network uses and is not the same measure as AI operational water consumption. Comparing the deck’s midpoint of 3.5 L gives a **volume-only** scale reference of roughly:

- **11 minutes** of the U.S. per-resident municipal-withdrawal average; or
- **1½ hours** of the Bangladesh per-resident municipal-withdrawal average.

Do not interpret these as locations, opportunity costs, or matched water footprints.

### Carbon dioxide

World Bank country profiles report 2024 territorial carbon-dioxide emissions excluding land-use change of approximately:

- United States: **13.6 t CO₂e per person per year**, or **37 kg per day**;
- Bangladesh: **0.7 t CO₂e per person per year**, or **1.9 kg per day**.

At those national per-resident rates, the deck’s modeled 0.35 kg CO₂e is equivalent to roughly **14 minutes** of the U.S. average or **4½ hours** of the Bangladesh average. This is scale only, not a matched life-cycle footprint or a claim about the computation’s location.
...
- room interactions remain in page memory and clear on reload;
...
- the Long Story Short embed, Google Fonts, and image-generation services are external and retain their own terms, accounts, histories, and data practices.
